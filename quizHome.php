        ...
        <div class="info">
            <div class="container">
                ...
                <div class="box-container">
                    <div class="box">
                        <div class="image">
                            <a href="quiz_1.php?languageID=<?php echo $languageID?>">
                                <img src="image/exam.jpg" alt="Description of the image" title="This is an example image">
                            </a>
                        </div>
                        <div class="content">
                            <h3>Quiz 1</h3>
                            <div class="icons">
                                <span><i class="fa-solid fa-book-open"></i>Reading</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="image">
                            <a href="quiz_2.php?languageID=<?php echo $languageID?>">
                                <img src="image/exam.jpg" alt="Description of the image" title="This is an example image">
                            </a>                        </div>
                        <div class="content">
                            <h3>Quiz 2</h3>
                            <div class="icons">
                                <span> <i class="fa-solid fa-book-open"></i>Listening</span>
                            </div>
                        </div>
                    </div>
