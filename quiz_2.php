<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    if(!isset($_POST['answer'])){
        ...
        echo "<meta http-equiv='refresh' content='0; url=quiz_2.php?languageID=$languageID'/>";
        exit;
    }
    ...
    $query = "SELECT * FROM assessment a, questions q WHERE a.ASSID = q.assID AND LEVEL = 2 AND LanguageID = '$languageID' ORDER BY questionID ASC;";
...
<div class="wrapper">
    ...
    <div class="main_content">
	    ...
	    <br>
	    <center><h3>Level: Normal</h3></center>

        <div class="card mb-3">
        <?php 
            $quizsql = "SELECT * FROM assessment a, questions q WHERE a.ASSID = q.assID AND LEVEL = 2 AND LanguageID = '$languageID';";
            ...
            if ($quizresult && mysqli_num_rows($quizresult)>0) {
                ...
                while ($row = mysqli_fetch_assoc($quizresult)) {
                    ...
                    <audio controls>
                        <source src="<?php echo $row['pathfile']?>"  type="audio/mpeg">
                    </audio>  
