...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <h1 class="heading">Lesson 3 (21 - 30)</h1>

        <div class="row row-cols-1 row-cols-md-3 g-4">
            <?php
                $sql = "SELECT * FROM content where languageid = '$languageID' limit 21,10;";
        ...
        <div class="card text-center" >
            ...
            <div class="card-body">
                <?php
                  $sqlVideo = "SELECT * FROM video WHERE LANGUAGEID = '" .$languageID. "' LIMIT 2, 1";
