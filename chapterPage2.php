...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <h1 class="heading">Lesson 2 (11 - 20)</h1>

        <div class="row row-cols-1 row-cols-md-3 g-4">
            <?php
                $sql = "SELECT * FROM content where languageid = '$languageID' limit 11,10;";
        ...
        <div class="card text-center" >
            ...
            <div class="card-body">
                <?php
                  $sqlVideo = "SELECT * FROM video WHERE LANGUAGEID = '" .$languageID. "' LIMIT 1, 1";
